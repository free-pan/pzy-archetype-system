...
/**
 * comm_dictionary表相关领域对象转化类
 *
 * @author pan
 * @since 2020-04-11
 */
@Mapper(componentModel = "spring", uses = {StringDataMapper.class})
public interface CommDictionaryMapStruct extends ComplexMapStruct<CommDictionarySearchDTO, CommDictionaryAddDTO, CommDictionaryEditDTO, CommDictionary, CommDictionaryVO> {
