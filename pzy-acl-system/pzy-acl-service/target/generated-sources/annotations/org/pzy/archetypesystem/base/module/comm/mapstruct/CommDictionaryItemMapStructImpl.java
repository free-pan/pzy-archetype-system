...
public class CommDictionaryItemMapStructImpl implements CommDictionaryItemMapStruct {
    ...
    public CommDictionaryItemSearchDTO searchDtoToSearchDTO(CommDictionaryItemSearchDTO searchDTO) {
        ...
        commDictionaryItemSearchDTO.setBeginDate( searchDTO.getBeginDate() );
        commDictionaryItemSearchDTO.setEndDate( searchDTO.getEndDate() );
        commDictionaryItemSearchDTO.setTargetFieldIsDatetime( searchDTO.getTargetFieldIsDatetime() );
        commDictionaryItemSearchDTO.setKw( stringDataMapper.stringMapper( searchDTO.getKw() ) );
        commDictionaryItemSearchDTO.setPg( searchDTO.getPg() );
